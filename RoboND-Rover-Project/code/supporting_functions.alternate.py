...
def create_output_images(Rover):
      ...
      #print("ANUPAM: ROVER X and ROVER Y", np.int(Rover.pos[0]), np.int(Rover.pos[1]))
      ...
      cv2.putText(map_add,"Anupam Time: "+str(np.round(Rover.total_time, 1))+' s', (0, 10), 
      ...
      cv2.putText(map_add,"  Collected: "+str(Rover.samples_collected), (0, 85), 
                  cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)
      cv2.putText(map_add,"  Rover At: "+str(rover_x)+' '+str(rover_y) , (0, 95), 
                  cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)
